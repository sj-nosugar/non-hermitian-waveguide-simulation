...
print('-dpng','-r600',sprintf('Modelb_spectrum_N%d_gamma%.2f_J1%.2f_J2%.2f.png', N, gamma, J1, J2));
...
grid on; box on;
axis equal;
print('-dpng','-r600',sprintf('Modelb_real_imag_N%d_gamma%.2f_J1%.2f_J2%.2f.png', N, gamma, J1, J2));
...
grid on; box on;
print('-dpng','-r600',sprintf('Modelb_prob_N%d_gamma%.2f_J1%.2f_J2%.2f_t%d.png', N, gamma, J1, J2, t_max));
...
grid on; box on;
print('-dpng','-r600',sprintf('Modelb_IPR_N%d_gamma%.2f_J1%.2f_J2%.2f_t%d.png', N, gamma, J1, J2, t_max));
...
axis xy;
grid on; box on;
print('-dpng','-r600',sprintf('Modelb_density_N%d_gamma%.2f_J1%.2f_J2%.2f_t%d.png', N, gamma, J1, J2, t_max));
...
hold off;
print('-dpng','-r600',sprintf('Modelb_final_N%d_gamma%.2f_J1%.2f_J2%.2f_t%d.png', N, gamma, J1, J2, t_max));
